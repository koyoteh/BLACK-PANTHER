...
const availableApis = [
    `${PantherApi}/api/ai/ai?apikey=${GuruApiKey}&q=`,
    `${PantherApi}/api/ai/mistral?apikey=${GuruApiKey}&q=`,
    `${PantherApi}/api/ai/meta-llama?apikey=${GuruApiKey}&q=`
];
